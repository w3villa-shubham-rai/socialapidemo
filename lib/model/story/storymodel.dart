...
class Datum {
  ...
  String? message; // Change this to a String
  ...
  factory Datum.fromJson(Map<String, dynamic> json) => Datum(
        ...
        sortedDate: json["sorted_date"] == null
            ? null
            : DateTime.parse(json["sorted_date"]),
        sortedType: sortedTypeValues.map[json["sorted_type"]]!,
        message: json["message"], // Change to String
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "sorted_date":
            "${sortedDate!.year.toString().padLeft(4, '0')}-${sortedDate!.month.toString().padLeft(2, '0')}-${sortedDate!.day.toString().padLeft(2, '0')}",
        "sorted_type": sortedTypeValues.reverse[sortedType],
        "message": message, // Change to String
      };
}
...
class Storymodel {
  ...
  factory Storymodel.fromJson(Map<String, dynamic> json) => Storymodel(
        ...
        topThree: json["top_three"] == null
            ? []
            : List<Datum>.from(json["top_three"]!.map((x) => Datum.fromJson(x))),
      );
